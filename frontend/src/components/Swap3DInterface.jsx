                ...
                <div className="flex justify-center" style={{ perspective: '1500px' }}>
                    ...
                    >
                        <div className="bg-gradient-to-br from-purple-900/50 to-teal-900/50 backdrop-blur-xl border border-white/20 rounded-3xl p-10 shadow-2xl">
                            ...
                            {/* Swap button */}
                            <button className="w-full py-5 bg-gradient-to-r from-teal-600 to-purple-600 rounded-2xl font-bold text-white text-xl hover:scale-105 transition-transform duration-300 shadow-2xl shadow-teal-500/50">
                                Swap Now
                            </button>
                        </div>
                        ...
                        {/* 3D shadow effect */}
                        <div
                            className="absolute inset-0 bg-gradient-to-br from-teal-900/30 to-purple-900/30 rounded-3xl blur-xl"
                            style={{
...
export default Swap3DInterface;
