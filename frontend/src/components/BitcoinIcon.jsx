...
const BitcoinIcon = ({ size = 32, className = "", glow = false }) => {
    return (
        <div className={`relative ${glow ? 'animate-pulse' : ''} ${className}`} style={{ width: size, height: size }}>
            {glow && (
                <div className="absolute inset-0 rounded-full bg-orange-400/40 blur-xl animate-pulse" />
            )}
            <svg
            ...
            >
                ...
                <g fill="none" fillRule="evenodd">
                    ...
                    <use fill="url(#btc-c)" style={{ mixBlendMode: "soft-light" }} xlinkHref="#btc-b" />
