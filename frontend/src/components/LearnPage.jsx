...
const LearnPage = () => {
    ...
    const kaspaTimeline = [
        ...
        { date: 'Feb 2023', event: 'DAGKnight whitepaper', description: 'Updated whitepaper for the next-generation DAGKnight protocol released' },
        { date: 'Jun 2024', event: 'KRC-20 beta launch', description: 'Kasplex goes live on mainnet with KRC-20 token standard' },
        { date: 'May 2025', event: 'Crescendo upgrade', description: 'Hard fork increasing block rates to 10 blocks per second (BPS)' }
    ];

    // Layer 2 solutions information
  ...
  "to": "kaspa:address..."
                        ...
                        <section id="defi" className="mb-16 animate-on-scroll opacity-0 transition-opacity duration-1000">
                            <div className="bg-black/30 backdrop-blur-sm border border-green-500/20 rounded-lg p-8">
                                ...
                                <div className="bg-black/50 border border-green-500/10 rounded-lg p-6">
                                    <h3 className="text-xl font-bold text-white mb-3">Current Development Initiatives</h3>

                                    <div className="space-y-6">
                                        <div>
                                            <p className="font-medium text-white">Kaspa Ecosystem Foundation (KEF)</p>
                                            <p className="text-gray-300 text-sm mt-1">
                                                Actively supporting research, development, and ecosystem growth through grants, partnerships,
                                                and sponsorships. KEF is backing projects like KasBay (a hub for Kaspa services), Kasplex
                                                (token infrastructure), and KasKeeper (wallet solution).
                                            </p>
                                        </div>

                                        <div>
                                            <p className="font-medium text-white">Kaspa Industrial Initiative (KII)</p>
                                            <p className="text-gray-300 text-sm mt-1">
                                                Focused on promoting enterprise adoption across various sectors including finance (cross-border
                                                payments, DeFi platforms, stablecoins), supply chain, and energy. KII aims to bring real-world
                                                use cases to the Kaspa network.
                                            </p>
                                        </div>

                                        <div>
                                            <p className="font-medium text-white">Community-Driven Development</p>
                                            <p className="text-gray-300 text-sm mt-1">
                                                Multiple independent teams are working on different aspects of the ecosystem, from
                                                wallet development to DEX creation. The open-source ethos of Kaspa encourages collaborative
                                                innovation.
                                            </p>
                                        </div>
                                    </div>
                        ...
                        {/* Roadmap Section */}
                        <section id="roadmap" className="mb-16 animate-on-scroll opacity-0 transition-opacity duration-1000">
                            <div className="bg-black/30 backdrop-blur-sm border border-green-500/20 rounded-lg p-8">
                                <h2 className="text-3xl font-bold text-green-400 mb-6">Kaspa Roadmap</h2>

                                <p className="mb-6 text-gray-300">
                                    Kaspa is following a strategic development roadmap that builds upon its core strengths while
                                    expanding its capabilities to support a rich ecosystem of applications. The project's approach
                                    balances technological innovation with practical implementation.
                                </p>

                                <div className="relative">
                                    {/* Vertical timeline line */}
                                    <div className="absolute left-[15px] md:left-1/2 top-0 bottom-0 w-px bg-green-500/30 transform md:-translate-x-1/2"></div>

                                    {/* Completed Phase */}
                                    <div className="relative mb-12 md:mb-16">
                                        <div className="flex flex-col md:flex-row items-start md:items-center">
                                            {/* Timeline dot */}
                                            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-8 h-8 rounded-full bg-green-500 border-4 border-black z-10 flex items-center justify-center">
                                            ...
                                            <div className="md:hidden pl-12">
                                                <div className="bg-green-500/10 rounded-lg p-4 border border-green-500/30">
                                                    <div className="text-green-400 font-bold mb-1">COMPLETED</div>
                                                    <h3 className="text-xl font-bold text-white mb-2">Foundation Phase</h3>
                                                    <ul className="text-gray-300 space-y-2">
                                                        <li className="flex items-start">
                                                            <svg className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                            Complete Rust codebase rewrite for performance
                                                        </li>
                                                        <li className="flex items-start">
                                                            <svg className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                        ...
                                                        <li className="flex items-start">
                                                            ...
                                                            KRC-20 token standard via Kasplex
                                                        </li>
                                                        <li className="flex items-start">
                                                            <svg className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                            KIP-14: Data payloads for transactions
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div className="hidden md:block w-1/2 pr-12 text-right">
                                                <div className="bg-green-500/10 rounded-lg p-4 border border-green-500/30 ml-auto">
                                                    <div className="text-green-400 font-bold mb-1">COMPLETED</div>
                                                    <h3 className="text-xl font-bold text-white mb-2">Foundation Phase</h3>
                                                    <ul className="text-gray-300 space-y-2">
                                                        <li className="flex items-start justify-end">
                                                            <span>Complete Rust codebase rewrite for performance</span>
                                                            <svg className="w-5 h-5 text-green-400 ml-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                        </li>
                                                        <li className="flex items-start justify-end">
                                                            <span>"Crescendo" hard fork to 10 blocks per second (BPS)</span>
                                                            <svg className="w-5 h-5 text-green-400 ml-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                        </li>
                                                        <li className="flex items-start justify-end">
                                                            <span>KRC-20 token standard via Kasplex</span>
                                                            <svg className="w-5 h-5 text-green-400 ml-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                        </li>
                                                        <li className="flex items-start justify-end">
                                                            <span>KIP-14: Data payloads for transactions</span>
                                                            <svg className="w-5 h-5 text-green-400 ml-2 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                                            </svg>
                                                        </li>
                                    ...
                                    <div className="relative mb-12 md:mb-16">
                                        <div className="flex flex-col md:flex-row items-start md:items-center">
                                            {/* Timeline dot */}
                                            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-8 h-8 rounded-full bg-green-400/20 border-4 border-black z-10 flex items-center justify-center">
                                            ...
                                            <div className="md:hidden pl-12">
                                                <div className="bg-black/50 rounded-lg p-4 border border-green-500/20">
                                                    <div className="text-green-400 font-bold mb-1">IN PROGRESS</div>
                                                    <h3 className="text-xl font-bold text-white mb-2">Ecosystem Expansion</h3>
                                                    <ul className="text-gray-300 space-y-2">
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-400 flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                                                                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                                                            </div>
                                                            DAGKnight consensus protocol development
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-400 flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                                                                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                                                            </div>
                                                            Kasplex L2 token infrastructure expansion
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-400 flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                                                                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                                                            </div>
                                                            Igra Labs EVM-compatible L2 development
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-400 flex items-center justify-center mr-2 mt-0.5 flex-shrink-0">
                                                                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                                                            </div>
                                                            KIP-15 implementation for L2 optimization
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div className="relative mb-12 md:mb-16">
                                        <div className="flex flex-col md:flex-row items-start md:items-center">
                                            {/* Timeline dot */}
                                            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-8 h-8 rounded-full bg-green-900/30 border-4 border-black z-10"></div>

                                            {/* Content for mobile */}
                                            <div className="md:hidden pl-12">
                                                <div className="bg-black/50 rounded-lg p-4 border border-green-500/10">
                                                    <div className="text-green-500/60 font-bold mb-1">UPCOMING</div>
                                                    <h3 className="text-xl font-bold text-white mb-2">Advanced L2 Development</h3>
                                                    <ul className="text-gray-400 space-y-2">
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Sparkle "Layer 1.5" ZK-rollup implementation
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Further block rate increases (aiming for 32 BPS)
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Decentralized exchange (DEX) primitives
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Advanced cross-chain bridging solutions
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            {/* Content for desktop - left side */}
                                            <div className="hidden md:block w-1/2 pr-12 text-right">
                                                <div className="bg-black/50 rounded-lg p-4 border border-green-500/10 ml-auto">
                                                    <div className="text-green-500/60 font-bold mb-1">UPCOMING</div>
                                                    <h3 className="text-xl font-bold text-white mb-2">Advanced L2 Development</h3>
                                                    <ul className="text-gray-400 space-y-2">
                                                        <li className="flex items-start justify-end">
                                                            <span>Sparkle "Layer 1.5" ZK-rollup implementation</span>
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 ml-2 mt-0.5 flex-shrink-0"></div>
                                                        </li>
                                                        <li className="flex items-start justify-end">
                                                            <span>Further block rate increases (aiming for 32 BPS)</span>
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 ml-2 mt-0.5 flex-shrink-0"></div>
                                                        </li>
                                                        <li className="flex items-start justify-end">
                                                            <span>Decentralized exchange (DEX) primitives</span>
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 ml-2 mt-0.5 flex-shrink-0"></div>
                                                        </li>
                                                        <li className="flex items-start justify-end">
                                                            <span>Advanced cross-chain bridging solutions</span>
                                                            <div className="w-5 h-5 rounded-full border border-green-500/30 ml-2 mt-0.5 flex-shrink-0"></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <div className="relative">
                                        <div className="flex flex-col md:flex-row items-start md:items-center">
                                            {/* Timeline dot */}
                                            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-8 h-8 rounded-full bg-green-900/20 border-4 border-black z-10"></div>

                                            {/* Content for mobile */}
                                            <div className="md:hidden pl-12">
                                                <div className="bg-black/40 rounded-lg p-4 border border-green-500/5">
                                                    <div className="text-green-500/50 font-bold mb-1">LONG-TERM VISION</div>
                                                    <h3 className="text-xl font-bold text-white mb-2">Native Smart Contracts & DeFi</h3>
                                                    <ul className="text-gray-500 space-y-2">
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/20 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Full smart contract deployment on L2 solutions
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/20 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Native lending and liquidity protocols
                                                        </li>
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/20 mr-2 mt-0.5 flex-shrink-0"></div>
                                                        ...
                                                        <li className="flex items-start">
                                                            <div className="w-5 h-5 rounded-full border border-green-500/20 mr-2 mt-0.5 flex-shrink-0"></div>
                                                            Advanced cross-chain composability
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        {/* FAQ Section */}
                        <section id="faq" className="mb-16 animate-on-scroll opacity-0 transition-opacity duration-1000">
                            <div className="bg-black/30 backdrop-blur-sm border border-green-500/20 rounded-lg p-8">
                                <h2 className="text-3xl font-bold text-green-400 mb-6">Frequently Asked Questions</h2>

                                <div className="space-y-6">
                                    <div className="bg-black/50 border border-green-500/10 rounded-lg overflow-hidden">
                                        <button className="w-full text-left py-4 px-6 focus:outline-none">
                                            <p className="text-xl font-bold text-white">What makes Kaspa different from other blockchains?</p>
                                        </button>
                                        <div className="py-4 px-6 border-t border-green-500/10">
                                            <p className="text-gray-300">
                                                Kaspa stands apart through its innovative BlockDAG architecture and GHOSTDAG consensus
                                                protocol, enabling high throughput (10 blocks per second currently) with near-instant
                                                transaction finality while maintaining strong security. Additionally, Kaspa had a fair
                                                launch with no pre-mine or token allocations, emphasizing true decentralization. Its
                                                focus on a lean Layer-1 with specialized Layer-2 solutions for smart contracts provides
                                    ...
                                    <div className="bg-black/50 border border-green-500/10 rounded-lg overflow-hidden">
                                        <button className="w-full text-left py-4 px-6 focus:outline-none">
                                            <p className="text-xl font-bold text-white">How do I get started with Kaspa?</p>
                                        </button>
                                        <div className="py-4 px-6 border-t border-green-500/10">
                                            <p className="text-gray-300 mb-3">
                                                To get started with Kaspa:
                                            </p>
                                            <ol className="list-decimal list-inside space-y-2 text-gray-300">
                                                <li>
                                                    <span className="text-white font-medium">Download a wallet:</span> Kasware and Kaspium are popular wallet options
                                                </li>
                                                <li>
                                                    <span className="text-white font-medium">Acquire KAS:</span> Purchase KAS from supported exchanges or swap another cryptocurrency for KAS
                                                </li>
                                                <li>
                                                    <span className="text-white font-medium">Explore the ecosystem:</span> Learn about KRC-20 tokens, community projects, and upcoming features
                                                </li>
                                                <li>
                                                    <span className="text-white font-medium">Join the community:</span> Connect with other Kaspa enthusiasts through Discord, Telegram, or other channels
                                                </li>
                                            </ol>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-black/50 border border-green-500/10 rounded-lg overflow-hidden">
                                        <button className="w-full text-left py-4 px-6 focus:outline-none">
                                            <p className="text-xl font-bold text-white">Does Kaspa have smart contracts?</p>
                                        </button>
                                        <div className="py-4 px-6 border-t border-green-500/10">
                                            <p className="text-gray-300">
                                                Currently, Kaspa does not have native smart contracts on its Layer-1. Instead, Kaspa
                                                is pursuing a multi-tier Layer-2 strategy with several solutions under development:
                                            </p>
                                            <ul className="list-disc list-inside mt-3 space-y-1 text-gray-300">
                                                <li>Kasplex: Enabling token functionality through KRC-20 standard</li>
                                                <li>Igra Network: Developing EVM-compatible Layer-2 for Ethereum smart contracts</li>
                                                <li>Sparkle: Building a "Layer 1.5" solution utilizing zero-knowledge proofs</li>
                                            </ul>
                                            <p className="mt-3 text-gray-300">
                                                This approach allows Kaspa's Layer-1 to maintain its focus on high throughput and security
                                                while specialized Layer-2 solutions handle complex smart contract execution.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-black/50 border border-green-500/10 rounded-lg overflow-hidden">
                                        <button className="w-full text-left py-4 px-6 focus:outline-none">
                                            <p className="text-xl font-bold text-white">What is the maximum supply of KAS?</p>
                                        </button>
                                        <div className="py-4 px-6 border-t border-green-500/10">
                                            <p className="text-gray-300">
                                                The maximum supply of KAS is approximately 28.7 billion tokens. As of May 2025,
                                                about 26.13 billion KAS (roughly 91% of the total) are in circulation. Kaspa follows
                                                a deflationary emission schedule where block rewards halve once per year through monthly
                                                adjustments. Each month, the reward decreases by a factor of (1/2)<sup>(1/12)</sup>,
                                                creating a smooth reduction curve rather than sudden halvings.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-black/50 border border-green-500/10 rounded-lg overflow-hidden">
                                        <button className="w-full text-left py-4 px-6 focus:outline-none">
                                            <p className="text-xl font-bold text-white">What is a BlockDAG and how does it differ from a traditional blockchain?</p>
                                        </button>
                                        <div className="py-4 px-6 border-t border-green-500/10">
                                            <p className="text-gray-300 mb-3">
                                                A BlockDAG (Directed Acyclic Graph) is a data structure that allows multiple blocks to be
                                                created simultaneously, unlike a traditional blockchain's linear chain:
                                            </p>

                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                                <div className="bg-black/30 p-3 rounded border border-green-500/10">
                                                    <p className="font-medium text-white mb-2">Traditional Blockchain:</p>
                                                    <ul className="list-disc list-inside text-gray-300 text-sm space-y-1">
                                                        <li>Single linear chain of blocks</li>
                                                        <li>One block added at a time</li>
                                                        <li>Blocks not chosen as "canonical" become orphaned</li>
                                                        <li>Limited throughput due to sequential processing</li>
                                                    </ul>
                                                </div>

                                                <div className="bg-black/30 p-3 rounded border border-green-500/10">
                                                    <p className="font-medium text-white mb-2">Kaspa BlockDAG:</p>
                                                    <ul className="list-disc list-inside text-gray-300 text-sm space-y-1">
                                                        <li>Network of blocks in a directed acyclic graph</li>
                                                        <li>Multiple blocks added in parallel</li>
                                                        <li>All valid blocks are included in the DAG</li>
                                                        <li>Higher throughput through parallel processing</li>
                                                    </ul>
                                                </div>
                                            </div>

                                            <p className="mt-4 text-gray-300">
                                                Kaspa's GHOSTDAG protocol determines the main chain within this DAG structure,
                                                enabling consensus even with parallel block creation.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-black/50 border border-green-500/10 rounded-lg overflow-hidden">
                                        <button className="w-full text-left py-4 px-6 focus:outline-none">
                                            <p className="text-xl font-bold text-white">How can I create a KRC-20 token?</p>
                                        </button>
                                        <div className="py-4 px-6 border-t border-green-500/10">
                                            <p className="text-gray-300 mb-3">
                                                Creating a KRC-20 token on Kaspa involves three main steps:
                                            </p>

                                            <ol className="list-decimal list-inside space-y-3 text-gray-300">
                                                <li>
                                                    <span className="text-white font-medium">Token Deployment:</span> Define your token
                                                    parameters including ticker symbol (e.g., "EXAMPLE"), maximum supply, and mint limit
                                                    per transaction.
                                                    <div className="mt-2 mb-3 bg-black/70 rounded p-2 font-mono text-xs text-green-300">
                                                        {`{
  "p": "KRC-20",
  "op": "deploy",
  "tick": "EXAMPLE",
  ...
  "lim": "1000000000"
                                                ...
                                                <li>
                                                    <span className="text-white font-medium">Token Minting:</span> Create new tokens
                                                    within the defined limits after deployment.
                                                    <div className="mt-2 mb-3 bg-black/70 rounded p-2 font-mono text-xs text-green-300">
                                                        {`{
  "p": "KRC-20",
  "op": "mint",
  "tick": "EXAMPLE"
                                                ...
                                                <li>
                                                    <span className="text-white font-medium">Token Transfer:</span> Send tokens to other addresses.
                                                    <div className="mt-2 bg-black/70 rounded p-2 font-mono text-xs text-green-300">
                                                        {`{
  "p": "KRC-20",
  "op": "transfer",
  ...
  "to": "kaspa:address..."
                                            ...
                                            <p className="mt-4 text-gray-300">
                                                Tools like the KSPR Bot on Telegram or dedicated wallet interfaces can help simplify this process.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="max-w-6xl mx-auto px-4 pb-20 text-center">
                <h2 className="text-3xl font-bold text-white mb-6">Ready to Explore Kaspa?</h2>
                <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                    Join the Kaspa ecosystem and experience the future of blockchain technology today.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-6 py-3 bg-green-500 hover:bg-green-400 text-black font-medium rounded-md transition-colors"
                    >
                        Visit Kaspa.org
                    </a>
                    <Link
                        to="/portal"
                        className="px-6 py-3 bg-black border border-green-500 hover:bg-green-500/10 text-green-400 font-medium rounded-md transition-colors"
                    >
                        Enter Kasportal
                    </Link>
                </div>
...
h - 10 rounded - full bg - green - 500 / 20 flex items - center justify - center text - green - 400 mr - 4 flex - shrink - 0">
    < RefreshCw size = { 20} />
                        </div >
    <div>
    ...
    <div className="bg-black/50 border border-green-500/10 rounded-lg p-6">
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start">
                ...
                <div>
                    <p className="font-medium text-white">Rapid Settlement</p>
                    <p className="text-gray-300 text-sm mt-1">
                        Near-instant transaction finality enables faster liquidations, more efficient
                        arbitrage, and reduced settlement risk, potentially allowing for more
                        capital-efficient DeFi protocols.
                    </p>
                </div>
            </div>
            ...
            <div className="flex items-start">
                ...
                <div>
                    <p className="font-medium text-white">Low Transaction Costs</p>
                    <p className="text-gray-300 text-sm mt-1">
                        Minimal fees make micro-transactions viable, enabling new DeFi use cases like
                        high-frequency trading strategies, micro-investments, and low-value asset tokenization
            ...
            <div className="flex items-start">
                ...
                <div>
                    <p className="font-medium text-white">Cross-Layer Composability</p>
                    <p className="text-gray-300 text-sm mt-1">
                        With multiple L2 solutions planned, Kaspa could develop unique cross-layer
                        composability, allowing DeFi protocols to leverage different layer strengths
                        (e.g., privacy from Sparkle, EVM compatibility from Igra) in a single application.
                    </p>
                </div>
            </div>
        </div>
